...
function Script:setRuneLevel(server, battle, unit, targetLevel)
	...
	-- TODO: Remove old rune level bonuses and apply bonuses for targetLevel here
	-- Example: Script:updateBonuses(server, unit, targetLevel)
	-- Play animation if level is greater than 0
...
function Script:addRuneLevels(server, battle, unit, amount)
	...
	applyRunes = applyRunes and bonusList:size() == 0
